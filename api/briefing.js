...
- 뉴스 출처 [언론사명](URL)은 절대 단독 줄에 쓰지 말 것. 반드시 기사 본문 문장 맨 끝, 같은 줄, 같은 문단에 붙여 쓸 것.
  올바른 예: "정부가 새 정책을 발표했습니다. [한겨레](https://example.com/news1)"
  잘못된 예: "정부가 새 정책을 발표했습니다.\n[한겨레](https://example.com/news1)" (줄바꿈 금지)
- (URL) 단독 표기 금지.
