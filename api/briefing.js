...
오늘 뉴스입니다
(뉴스 1 본문. 국내외 정치·사회·경제 시사 이슈 중 오늘의 주요 뉴스 하나를 한두 문장으로. 문장 끝에 기사 URL을 괄호로.)
(뉴스 2 본문. 위와 다른 주제의 주요 시사 뉴스 하나를 한두 문장으로. 반드시 작성해야 해. 문장 끝에 기사 URL을 괄호로.)
...
규칙:
- 기온은 섭씨(℃)만.
- 기사는 한국 언론사로 가져오며, 하이퍼링크를 반드시 URL에 연결.
- 언론 매체 중 중앙일보, 조선일보, 동아일보는 인용 금지.
